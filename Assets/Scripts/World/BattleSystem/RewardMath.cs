...
public class RewardMath : RewardBaseValues
{
    ...
    //    OldPlayerExpController.AddExpForBattle(CalculatedExp);
    //}
    ...
    //    {
    //        item = ItemDatahandler.ItemsList[random.Next(0, ItemDatahandler.ItemsList.Count - 1)].Clone();
    //        OldPlayerItemsController.AddNewItemInInventory(item);
    //    }
    //}
}
