...
namespace Server
{
    ...
    public partial class RogDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetExpData_Result> GetExpData(Nullable<int> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetExpData_Result>("GetExpData", userIdParameter);
        }
        ...
        public virtual int UpdateUserExp(Nullable<int> userId, Nullable<int> currentExp, Nullable<int> reqExp, Nullable<int> lvl, Nullable<int> freePoints, ObjectParameter opResult)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
    
            var currentExpParameter = currentExp.HasValue ?
                new ObjectParameter("currentExp", currentExp) :
                new ObjectParameter("currentExp", typeof(int));
    
            var reqExpParameter = reqExp.HasValue ?
                new ObjectParameter("reqExp", reqExp) :
                new ObjectParameter("reqExp", typeof(int));
    
            var lvlParameter = lvl.HasValue ?
                new ObjectParameter("lvl", lvl) :
                new ObjectParameter("lvl", typeof(int));
    
            var freePointsParameter = freePoints.HasValue ?
                new ObjectParameter("freePoints", freePoints) :
                new ObjectParameter("freePoints", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateUserExp", userIdParameter, currentExpParameter, reqExpParameter, lvlParameter, freePointsParameter, opResult);
        }
    }
}
